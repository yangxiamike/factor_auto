"""Write evaluation artifacts to the standard run directory layout."""
...
class ArtifactWriter:
    """Handle run directory setup and artifact writes."""
    ...
    def write_results(
        ...
        diagnostics_path = self.context.diagnostics_path
